...
impl AccessControlContract {
    ...
    pub fn get_metadata(env: Env) -> PublicMetadata {
        PublicMetadata {
            name: soroban_sdk::String::from_str(&env, "Veltro Access Control"),
            version: soroban_sdk::String::from_str(&env, VERSION),
            author: soroban_sdk::String::from_str(&env, "Veltro Team"),
            description: soroban_sdk::String::from_str(
                &env,
                "Role-based access control contract for Veltro",
            ),
            repository: soroban_sdk::String::from_str(
                &env,
                "https://github.com/veltro/contracts",
            ),
