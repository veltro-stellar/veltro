use veltro_backend::ml::PredictionFeatures;
...
fn test_prediction_result_risk_levels() {
    use veltro_backend::api::ml::PredictionResponse;
    use veltro_backend::ml::PredictionResult;
...
fn test_simple_model_prediction() {
    use veltro_backend::ml::SimpleMLModel;
