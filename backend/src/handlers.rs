...
fn render_pool_metrics_prometheus(metrics: &crate::database::PoolMetrics) -> String {
    format!(
        "# HELP veltro_db_pool_size Database pool size\n\
# TYPE veltro_db_pool_size gauge\n\
veltro_db_pool_size {}\n\
# HELP veltro_db_pool_idle Database pool idle connections\n\
# TYPE veltro_db_pool_idle gauge\n\
veltro_db_pool_idle {}\n\
# HELP veltro_db_pool_active Database pool active connections\n\
# TYPE veltro_db_pool_active gauge\n\
veltro_db_pool_active {}\n",
...
mod tests {
    ...
    fn test_render_pool_metrics_prometheus() {
        ...
        assert!(rendered.contains("veltro_db_pool_size 12"));
        assert!(rendered.contains("veltro_db_pool_idle 3"));
        assert!(rendered.contains("veltro_db_pool_active 9"));
        assert!(rendered.contains("# TYPE veltro_db_pool_size gauge"));
    }
}
