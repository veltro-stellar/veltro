...
export default function AlertsPage() {
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            {isFormOpen && (
                <div className="mb-10 bg-card dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-1">
                    <div className="bg-card dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden h-full flex flex-col">
                        <div className="px-6 py-5 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50">
                                    ...
                                    {history.filter(h => !h.is_dismissed).map((alert) => (
                                        <div
                                            ...
                                            className={`p-4 rounded-lg border ${alert.is_read
                                                    ? "bg-muted/20 border-gray-200 dark:bg-gray-800/50 dark:border-gray-700"
