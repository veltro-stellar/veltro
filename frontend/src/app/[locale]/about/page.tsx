...
export const metadata: Metadata = {
 title: "About Us — Veltro",
 description:
   "Learn about Veltro — the team behind institutional-grade telemetry for the Stellar payment network.",
};
   ...
   <div className="max-w-5xl mx-auto space-y-16">
     ...
     <section className="text-center space-y-5 pt-4">
       ...
       <p className="text-muted-foreground text-lg max-w-2xl mx-auto leading-relaxed">
         Veltro was created to give institutions, developers, and traders the
