...
export const metadata: Metadata = {
 title: "How to Use — Veltro",
 description:
   "A step-by-step guide to getting started with Veltro — connect your wallet, explore corridors, and monitor network health.",
};
   ...
   <div className="max-w-4xl mx-auto space-y-14">
     ...
     <section className="text-center space-y-5 pt-4">
       ...
       <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight text-foreground">
         How to Use{" "}
         <span className="text-accent">Veltro</span>
       </h1>
