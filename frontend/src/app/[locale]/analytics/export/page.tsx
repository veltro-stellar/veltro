...
import { ArrowLeft, Download, FileText, Mail, Table } from "lucide-react";
      ...
      <div className="p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto min-h-screen flex flex-col">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 flex-1">
          ...
          <div className="lg:col-span-4 space-y-8">
            <div className="bg-card dark:bg-slate-800 p-6 rounded-xl border border-gray-200 dark:border-slate-700 shadow-sm space-y-6">
              <DateRangeSelector
                startDate={startDate}
                endDate={endDate}
                onChange={(s, e) => {
            ...
            {/* Export Actions */}
            <div className="bg-card dark:bg-slate-800 p-6 rounded-xl border border-gray-200 dark:border-slate-700 shadow-sm">
              ...
              <div className="grid grid-cols-1 gap-3">
                <button
                  ...
                  className="flex items-center justify-center gap-2 w-full py-2.5 px-4 bg-card dark:bg-slate-800 border border-gray-300 dark:border-slate-600 rounded-lg hover:bg-gray-50 dark:hover:bg-slate-700 transition font-medium text-sm text-gray-700 dark:text-gray-200"
                >
