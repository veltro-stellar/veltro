...
function ComparisonContent() {
  ...
  if (selectedIds.length === 0) {
    return (
      <div className="text-center py-20 bg-card dark:bg-slate-800 rounded-2xl shadow-sm border border-dashed border-gray-300 dark:border-slate-700">
        <BarChart3 className="w-16 h-16 text-gray-300 mx-auto mb-4" />
        <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-2">
          No Corridors Selected
        </h2>
        <p className="text-gray-500 dark:text-gray-400 mb-6 px-4">
          Select up to 3 corridors from the listing page to compare them
          side-by-side.
        </p>
        <Link
          href="/corridors"
    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        <div className="flex items-center gap-2">
          {selectedIds.length < 4 && (
            <button
              ...
              className="flex items-center gap-2 bg-card dark:bg-slate-800 border border-gray-200 dark:border-slate-700 px-4 py-2 rounded-lg font-semibold text-gray-700 dark:text-gray-200 hover:border-blue-500 transition-all shadow-sm"
            >
          ...
          <button
            ...
            className="flex items-center gap-2 bg-card dark:bg-slate-800 border border-gray-200 dark:border-slate-700 px-4 py-2 rounded-lg font-semibold text-gray-700 dark:text-gray-200 hover:border-green-500 transition-all shadow-sm"
          >
      ...
      {showAddModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-card dark:bg-slate-800 rounded-lg p-6 max-w-md w-full mx-4">
            ...
            <input
              ...
              className="w-full px-4 py-2 border border-gray-300 dark:border-slate-600 rounded-lg bg-card dark:bg-slate-700 text-gray-900 dark:text-white mb-4"
