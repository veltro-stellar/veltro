    ...
    <MainLayout>
      <div className="p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto">
        ...
        <div className="space-y-4">
          <div className="bg-card dark:bg-slate-800 rounded-lg border border-gray-200 dark:border-slate-700 overflow-hidden">
            {loading ? (
        ...
        {!loading && !error && sortedAndFilteredAnchors.length > 0 && (
          <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="bg-card dark:bg-slate-800 rounded-lg border border-gray-200 dark:border-slate-700 p-4">
        ...
        {!loading &&
          ...
          sortedAndFilteredAnchors.length === 0 &&
          anchors.length > 0 && (
            <div className="bg-card dark:bg-slate-800 rounded-lg border border-gray-200 dark:border-slate-700 p-12 text-center">
