        ...
        {isOpen && (
          ...
          >
            ...
            <motion.div
              ...
              className="relative w-full max-w-2xl h-[80vh] bg-card dark:bg-slate-900 rounded-2xl shadow-2xl border border-gray-200 dark:border-slate-700 overflow-hidden flex flex-col"
            >
              {/* Header */}
