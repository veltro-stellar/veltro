...
const PRIORITY_BADGES: Record<NotificationPriority, { label: string; className: string }> = {
  low: { label: 'Low', className: 'bg-muted/30 text-gray-800 dark:bg-gray-800 dark:text-gray-200' },
    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="absolute right-0 top-0 h-full w-full max-w-md bg-card dark:bg-gray-900 shadow-xl"
            ...
            <div className="mt-4 space-y-3">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-card dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
              </div>
              ...
              <div className="flex flex-wrap gap-2">
                <select
                  ...
                  className="px-3 py-1 text-sm border border-gray-300 dark:border-gray-600 rounded-md bg-card dark:bg-gray-800 text-gray-900 dark:text-white"
                >
                          ...
                          <motion.div
                            ...
                            className={`
                              ...
                              ${notification.read 
                                ...
                                : 'bg-card dark:bg-gray-900 border-blue-200 dark:border-blue-800 shadow-sm'
                              }
                            `}
