        ...
        <AnimatePresence>
          {showPreview && recentUnread.length > 0 && (
            <motion.div
              ...
              className="absolute top-full right-0 mt-2 w-80 bg-card dark:bg-slate-900 rounded-lg shadow-lg border border-gray-200 dark:border-slate-700 z-50"
            >
              {/* Preview Header */}
        ...
        <AnimatePresence>
          {isOpen && (
            <motion.div
              ...
              className="absolute top-full right-0 mt-2 w-96 bg-card dark:bg-slate-900 rounded-lg shadow-lg border border-gray-200 dark:border-slate-700 z-50"
            >
              <div className="p-4">
