  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <motion.div
        ...
        className="bg-card dark:bg-gray-900 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700"
      >
        {/* Header */}
                  ...
                  <div
                    ...
                    className={`p-3 rounded-lg border ${
                      notification.read
                        ...
                        : 'bg-card dark:bg-gray-900 border-blue-200 dark:border-blue-800'
                    }`}
                  >
