          ...
          <button
            ...
            className={`py-1.5 px-3 rounded-lg text-sm font-medium transition ${
              preset === p
                ...
                : "bg-card dark:bg-slate-800 border border-gray-200 dark:border-slate-700 text-gray-700 dark:text-gray-200"
            }`}
          >
            {p === "24h"
              ? "24h"
      ...
      {preset === "custom" && (
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <input
              type="date"
              className="w-full px-3 py-2 bg-card dark:bg-slate-800 border border-gray-300 dark:border-slate-700 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none"
