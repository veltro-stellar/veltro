...
# Blue-green deployment script for veltro backend
# Usage: ./scripts/deploy.sh <environment> <image-tag>

AWS_REGION="us-east-1"
ECR_REPOSITORY="veltro-backend"
CONTAINER_NAME="veltro"
CONTAINER_PORT=8080
...
CLUSTER="veltro-${ENVIRONMENT}"
TASK_FAMILY="veltro-${ENVIRONMENT}"
CODEDEPLOY_APP="veltro-${ENVIRONMENT}"
CODEDEPLOY_GROUP="veltro-${ENVIRONMENT}-dg"
