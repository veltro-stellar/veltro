#!/bin/bash
# Complete Vault Setup Script for veltro
...
create_secrets() {
    ...
    vault kv put secret/stellar/database_url value="sqlite:///data/veltro.db"
...
main() {
    echo -e "${BLUE}╔════════════════════════════════════════════════════════╗${NC}"
    echo -e "${BLUE}║${NC}   Vault Setup for veltro                      ${BLUE}║${NC}"
    echo -e "${BLUE}╚════════════════════════════════════════════════════════╝${NC}"
    ...
    echo ""
    echo -e "${GREEN}✓ Vault is ready for veltro!${NC}"
    echo ""
    echo "Next steps:"
